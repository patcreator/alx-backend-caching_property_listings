...
INSTALLED_APPS = [
    ...
    'properties',
    'django_redis',  # Add django-redis to installed apps
]
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost',  # Use 'postgres' when running in Docker network
        'PORT': '5432',
    }
}
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://localhost:6379/1',  # Use DB 1 for caching
        'OPTIONS': {
